<template>
    <div v-if="dataAPI" id="container">
        <div class="weather-img">
            <div class="weather-temp">
                <img v-bind:src="imgSource" alt="Current weather" class="weather-state">
        ...
        <div class="show-info-weather" @click="changeSize()">
            <button>
                <img class="icon-switching" src="https://img.icons8.com/external-those-icons-flat-those-icons/24/000000/external-Arrow-arrows-those-icons-flat-those-icons-45.png" alt="switch icon">
            </button>
        </div>
        ...
        methods:{
            handleAPI(data){
                if(data){
                    ...
                    this.visibility = Math.round(data.visibility - 273.15 )
            ...
            changeSize(){
                ...
                const showInfoWeather = document.querySelector('.show-info-weather')
